...
const RoleSelectorModal= ({profile}:{profile:{address:string}}) =>{
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      { !profile?.address&&<div className="text-lg py-2 my-8">
       <label htmlFor="address" className="font-bold text-gray-800">Locale</label>
     <input name="address" placeholder="Where do you Reside - (eg. Rivers State)" type='text' className="input focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 py-2" />
     </div>}
          </form>  
        </div>
      </div>
